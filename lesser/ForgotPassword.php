		...
		<div class="container">
			...
			<div class="row">
				<div class="col-md-6 col-md-offset-3 text-center fh5co-heading">
					<h2>ตั้งรหัสใหม่</h2>
					<p><span>Reset Your Password</span></p>
				</div>
			</div>
			...
			<div class="row">
				...
				<div class="col-md-10 col-md-push-1 col-sm-12 col-sm-push-0 col-xs-12 col-xs-push-0">
					...
					<div class="work-inner">
						<a  class="work-grid" style="background-image: url(uploads_product/passwprd.jpg);" id="blah" >
						</a>
							...
							<div class="col-md-6">
								<div class="form-group">
									...
									<input class="form-control" placeholder="ชื่อผู้ใช้งาน" type="text" name="name" required>
