...
<?php
	...
	$sql="SELECT d.name as ProductName FROM selllist s INNER join product d 
			on s.productid = d.id
			INNER JOIN login l 
					...
					<div class="row">
						<div class="col-md-12">
							<div class="about-inner">
								<img class="img-responsive" src="images/carrot.jpg" alt="About" height="100%" width="100%">
					...
					<aside class="sidebar">
						<div class="row">
							...
							<div class="col-md-12 side">
								...
								<ul>
									<li>
										<li><i class="fas fa-map-marker-alt"></i><a href="#">415 ต.สันทราย</a></li>
									<li><i class="fas fa-map-pin"></i></i><a href="#"> ห่างออกไป 14 กม.</a></li>
									<li><i class="fas fa-phone"></i><a href="#">067-8957894</a></li>
									<li><i class="icon-facebook"></i><a href="#">Somchat kasetsin</a></li>
									<li><i class="fab fa-line"></i><a href="#">Somechai478</a></li>
						</a>
									</li>
