<?php
	...
	$queryMarketId=mysqli_query($objCon,$sql);
	$objResultMarket = mysqli_fetch_array($queryMarketId, MYSQLI_ASSOC);
?>
<!DOCTYPE html>
		...
		<div class="container">
			...
			<div class="row">
				...
				<div class="col-md-10 col-md-push-1 col-sm-12 col-sm-push-0 col-xs-12 col-xs-push-0">
					<div class="row">
						<form action="Edit-market-admin.php" method="post" enctype="multipart/form-data">
						<input type="hidden" name="id" value="<?php echo $objResultMarket['id'] ?>">
			<div class="col-md-4 text-center">

					<div class="work-inner">
						<a  class="work-grid" style="background-image: url(uploads_product/<?php echo $objResultMarket['pictureMarket'] ?>);" id="blah" >
						</a>
						<input type="hidden" name="pictureMarket" value="<?php echo $objResultMarket['pictureMarket'] ?>">
						<div class="desc">
							...
							<div class="col-md-6">
								<div class="form-group">
									...
									<input class="form-control" placeholder="ชื่อสถานที่" value="<?php echo $objResultMarket['market'] ?>" type="text" name="market_name" required="">
								</div>
							</div>
							<div class="col-md-3">
								<div class="form-group">
									<label>latitude</label>
									<input class="form-control" placeholder="" id="lati" type="text" name="latitude"  required="" value="<?php echo $objResultMarket['latitude'] ?>">
								</div>
							</div>
							<div class="col-md-3">
								<div class="form-group">
									<label>longitude</label>
									<input class="form-control" placeholder="" id="longi" type="text" name="longitude" required="" value="<?php echo $objResultMarket['longitude'] ?>">
								</div>
							</div>
							<div class="col-md-6">
							...
							<div class="col-md-6">
								<div class="form-group">
									<label>ที่อยู่ตลาด</label>
									<input class="form-control" placeholder="ที่อยู่" type="text" name="address" value="<?php echo $objResultMarket['market_address'] ?>">
								</div>
							</div>
							<div class="col-md-6">
								<div class="form-group">
									<label>เบอร์โทรศัพท์</label>
									<input class="form-control" placeholder="เบอร์โทรศัพท์" type="text" name="tel" value="<?php echo $objResultMarket['market_tel'] ?>">
								</div>
							</div>
							<div class="col-md-6">
								<div class="form-group">
									<label>ประเภทสินค้าที่ขาย</label>
									<input class="form-control" placeholder="ประเภทสินค้าที่ขาย" type="text" name="Categoryfactor" value="<?php echo $objResultMarket['market_Categoryfactor'] ?>">
								</div>
							</div>
							<div class="col-md-6">
								<div class="form-group">
									...
									<select class="form-control" name="market_type">
										<?php while ($row = mysqli_fetch_array($query, MYSQLI_ASSOC)) {?>
											<?php if($objResultMarket['market_type_id']==$row["market_type_id"]){ ?>
							...
							<div class="col-md-6">
								<div class="form-group">
									...
									<input class="form-control" placeholder="เวลาที่เปิด" type="text"name="openingTime" value="<?php echo $objResultMarket['openingTime'] ?>">
								</div>
							</div>
							<div class="col-md-6">
								<div class="form-group">
									<label>เวลาปิด</label>
									<input class="form-control" placeholder="เวลาปิด" type="text" name="closingTime" value="<?php echo $objResultMarket['closingTime'] ?>">
								</div>
							</div>
							<div class="col-md-6">
								<div class="form-group">
									<label>วันที่เปิด</label>
									<input class="form-control" placeholder="" type="text" name="opendateO" readonly="" value="<?php echo $objResultMarket['openDate'] ?>">
								</div>
							</div>
							<br>
							<div class="col-md-6">
